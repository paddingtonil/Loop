        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack(alignment: .center, spacing: 14) {
                ...
                VStack(alignment: .leading, spacing: 5) {
                    ...
                    tirLabelRow(percent: g.timeInTightRange, label: NSLocalizedString("In Tight Range", comment: "LoopInsights TITR tight label"), isBold: false, color: Self.clarityTight)
